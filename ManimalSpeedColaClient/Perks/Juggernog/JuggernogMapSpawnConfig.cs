...
{
    // sibling of MapSpawnConfig but for the Juggernog machine. hardcoded
    // after placement was dialed in.
    public static class JuggernogMapSpawnConfig
    {
        public class Entry
        {
        ...
        {
            Add("factory4_day", enabled: true, pos: "-41.45, 1.8, 45.6", rot: "0, 90, 0");
        }
