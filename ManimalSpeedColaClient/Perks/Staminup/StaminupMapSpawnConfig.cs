...
{
    // sibling of JuggernogMapSpawnConfig but for the Staminup machine.
    // hardcoded after placement was dialed in.
    public static class StaminupMapSpawnConfig
    {
        public class Entry
        {
        ...
        {
            Add("factory4_day", enabled: true, pos: "-19.8, -2.5, -22.7", rot: "0, 180, 0");
        }
