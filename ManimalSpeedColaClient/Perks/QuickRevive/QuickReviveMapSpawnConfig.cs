...
{
    // sibling of DeathPerceptionMapSpawnConfig / JuggernogMapSpawnConfig.
    // hardcoded after placement was dialed in.
    public static class QuickReviveMapSpawnConfig
    {
        public class Entry
        {
        ...
        {
            Add("factory4_day", enabled: true, pos: "76, -0.1, -45", rot: "0, -90, 0");
        }
