...
{
    // sibling of JuggernogMapSpawnConfig / StaminupMapSpawnConfig but for the
    // Death Perception machine. hardcoded after placement was dialed in.
    public static class DeathPerceptionMapSpawnConfig
    {
        public class Entry
        {
        ...
        {
            Add("factory4_day", enabled: true, pos: "6.9, 7.521, 54.358", rot: "0, -90, 0");
        }
