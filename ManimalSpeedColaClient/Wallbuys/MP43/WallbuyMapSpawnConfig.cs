...
{
    // per-map spawn data for the MP-43 wallbuy. hardcoded after the placement
    // was dialed in - mirrors MapSpawnConfig's HardcodedSetting<T> conversion.
    public static class WallbuyMapSpawnConfig
    {
        public class Entry
        {
        ...
        {
            Add("factory4_day", enabled: true, pos: "16.670, 1.5, -1.26", rot: "0, -90, 0");
        }
