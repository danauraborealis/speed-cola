...
{
    // sibling of UmpWallbuyMapSpawnConfig but for the STG-44 wallbuy.
    // hardcoded after placement was dialed in.
    public static class StgWallbuyMapSpawnConfig
    {
        public class Entry
        {
        ...
        {
            Add("factory4_day", enabled: true, pos: "44.8, 5.7, 42.045", rot: "0, -90, 0");
        }
