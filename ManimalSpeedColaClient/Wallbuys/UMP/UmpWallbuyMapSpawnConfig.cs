...
{
    // sibling of WallbuyMapSpawnConfig but for the UMP-45 wallbuy. hardcoded
    // after placement was dialed in.
    public static class UmpWallbuyMapSpawnConfig
    {
        public class Entry
        {
        ...
        {
            Add("factory4_day", enabled: true, pos: "-23.046, 3.9, -5", rot: "0, 180, 0");
        }
