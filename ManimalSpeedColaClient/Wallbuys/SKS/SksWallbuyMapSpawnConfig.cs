...
{
    // sibling of StgWallbuyMapSpawnConfig. hardcoded after placement was
    // dialed in.
    public static class SksWallbuyMapSpawnConfig
    {
        public class Entry
        {
        ...
        {
            Add("factory4_day", enabled: true, pos: "3.362, 1.5, -36.273", rot: "0, 90, 0");
        }
